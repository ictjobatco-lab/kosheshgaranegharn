...
const NAV_LINKS = [
  ...
  { href: "/consultant", label: "دستیار هوشمند" },
];
    ...
    >
      <Container className="flex h-[4.5rem] items-center justify-between gap-4">
          ...
          <ul className="flex items-center gap-8">
            {NAV_LINKS.map((link) => (
              <li key={link.href}>
                <a
                  href={link.href}
                  className="rounded text-[0.95rem] text-ink/80 transition-colors hover:text-brass"
                >
                  {link.label}
                </a>
              </li>
        ...
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-btn text-ink lg:hidden"
