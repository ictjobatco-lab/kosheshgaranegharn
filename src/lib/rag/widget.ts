...
export const DEFAULT_WIDGET_CONFIG: WidgetConfig = {
  enabled: true,
  primary_color: "#7C6FF0",
  position: "left",
  welcome_message:
    "سلام! من دستیار هوشمند کوشش‌گران قرن هستم. چطور می‌توانم درباره‌ی خدمات نرم‌افزار و فناوری اطلاعات کمکتان کنم؟",
  launcher_text: "گفت‌وگو با دستیار هوشمند",
  allowed_domains: [],
};
