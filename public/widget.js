/*
 * ویجت چت کوشش‌گران قرن — اسنیپت قابل‌جاسازی
 * نصب در هر سایت:
...
(function () {
  ...
  function init(cfg) {
    var color = cfg.primary_color || "#7C6FF0";
    var bone = "#141A38";
    var side = cfg.position === "right" ? "right" : "left";
    var launcherText = cfg.launcher_text || "گفت‌وگو با دستیار هوشمند";
    var isOpen = false;
    ...
    iframe.title = "دستیار هوشمند کوشش‌گران قرن";
    iframe.style.cssText =
      ...
      "box-shadow:0 12px 48px rgba(35,43,92,0.22);margin-bottom:12px;display:none;";
    ...
    btn.style.cssText =
      ...
      "box-shadow:0 6px 22px rgba(35,43,92,0.28);transition:transform .15s ease;";
